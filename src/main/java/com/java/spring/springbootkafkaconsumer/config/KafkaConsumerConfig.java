package com.java.spring.springbootkafkaconsumer.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> currentKafkaListenerContainerFactory() {
